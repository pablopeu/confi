        ...
        <div className="fixed bottom-20 right-4 sm:bottom-24 sm:right-6 flex flex-col gap-2 sm:gap-3 z-[100]">
          ...
          {instructionsConfig?.enabled && (
            <button
              ...
              className="w-7 h-7 sm:w-14 sm:h-14 rounded-full bg-gray-800 hover:bg-gray-900 text-white flex items-center justify-center shadow-lg transition-all hover:scale-110 relative"
            ...
            >
              ...
              <FontAwesomeIcon icon={faQuestionCircle} className="text-xl sm:text-3xl relative z-10" />
            </button>
          )}
          ...
          {telegramConfig?.enabled && telegramConfig.username && (
            <a
              ...
              className="w-7 h-7 sm:w-14 sm:h-14 rounded-full bg-[#0088cc] hover:bg-[#0077b3] text-white flex items-center justify-center shadow-lg transition-all hover:scale-110"
              title="Contactar por Telegram"
            >
              <svg className="w-3.5 h-3.5 sm:w-7 sm:h-7" fill="currentColor" viewBox="0 0 24 24">
          ...
          {whatsappConfig?.enabled && whatsappConfig.number && (
            <a
              ...
              target="_blank"
              rel="noopener noreferrer"
              className="w-7 h-7 sm:w-14 sm:h-14 rounded-full bg-[#25D366] hover:bg-[#20BA5A] text-white flex items-center justify-center shadow-lg transition-all hover:scale-110"
        ...
        <div className="fixed bottom-20 right-4 sm:bottom-24 sm:right-6 flex flex-col gap-2 sm:gap-3 z-[100]">
          ...
          {telegramConfig?.enabled && telegramConfig.username && (
            <button
              ...
              className="w-7 h-7 sm:w-14 sm:h-14 rounded-full bg-[#0088cc] hover:bg-[#0077b3] text-white flex items-center justify-center shadow-lg transition-all hover:scale-110 disabled:opacity-50"
          ...
          {whatsappConfig?.enabled && whatsappConfig.number && (
            <button
              ...
              disabled={savingConfigurator}
              className="w-7 h-7 sm:w-14 sm:h-14 rounded-full bg-[#25D366] hover:bg-[#20BA5A] text-white flex items-center justify-center shadow-lg transition-all hover:scale-110 disabled:opacity-50"
